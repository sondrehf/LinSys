 ...
 */
#ifndef RTW_HEADER_P4p2_vopy_h_
#define RTW_HEADER_P4p2_vopy_h_
#include <string.h>
#ifndef P4p2_vopy_COMMON_INCLUDES_
# define P4p2_vopy_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* P4p2_vopy_COMMON_INCLUDES_ */

#include "P4p2_vopy_types.h"
...
#define P4p2_vopy_rtModel              RT_MODEL_P4p2_vopy_T
...
typedef struct {
  ...
  real_T Constant1[6];                 /* '<S5>/Constant1' */
...
#define rtB                            P4p2_vopy_B
#define BlockIO                        B_P4p2_vopy_T
#define rtX                            P4p2_vopy_X
#define ContinuousStates               X_P4p2_vopy_T
#define rtXdot                         P4p2_vopy_XDot
#define StateDerivatives               XDot_P4p2_vopy_T
#define tXdis                          P4p2_vopy_XDis
#define StateDisabled                  XDis_P4p2_vopy_T
#define rtP                            P4p2_vopy_P
#define Parameters                     P_P4p2_vopy_T
#define rtDWork                        P4p2_vopy_DW
#define D_Work                         DW_P4p2_vopy_T

/* Parameters (auto storage) */
struct P_P4p2_vopy_T_ {
  ...
  real_T PitchTransferFcn_D;           /* Computed Parameter: PitchTransferFcn_D
                                        * Referenced by: '<S3>/Pitch: Transfer Fcn'
                                        */
  real_T Gain_Gain_lq;                 /* Expression: 180/pi
...
extern P_P4p2_vopy_T P4p2_vopy_P;

/* Block signals (auto storage) */
extern B_P4p2_vopy_T P4p2_vopy_B;

/* Continuous states (auto storage) */
extern X_P4p2_vopy_T P4p2_vopy_X;

/* Block states (auto storage) */
extern DW_P4p2_vopy_T P4p2_vopy_DW;
...
extern void P4p2_vopy_initialize(void);
extern void P4p2_vopy_output0(void);
extern void P4p2_vopy_update0(void);
extern void P4p2_vopy_output(int_T tid);
extern void P4p2_vopy_update(int_T tid);
extern void P4p2_vopy_terminate(void);

/* Real-time Model object */
extern RT_MODEL_P4p2_vopy_T *const P4p2_vopy_M;
 ...
 *
 * '<Root>' : 'P4p2_vopy'
 * '<S1>'   : 'P4p2_vopy/Conversion'
 * '<S2>'   : 'P4p2_vopy/Estimator '
 * '<S3>'   : 'P4p2_vopy/Heli 3D'
 * '<S4>'   : 'P4p2_vopy/Joystick'
 * '<S5>'   : 'P4p2_vopy/lqr controller'
 * '<S6>'   : 'P4p2_vopy/Heli 3D/Elevation rad to deg'
 * '<S7>'   : 'P4p2_vopy/Heli 3D/Elevation rate rad to deg'
 * '<S8>'   : 'P4p2_vopy/Heli 3D/Pitch rad to deg'
 * '<S9>'   : 'P4p2_vopy/Heli 3D/Pitch rate rad to deg'
 * '<S10>'  : 'P4p2_vopy/Heli 3D/Travel rad to deg'
 * '<S11>'  : 'P4p2_vopy/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_P4p2_vopy_h_ */
