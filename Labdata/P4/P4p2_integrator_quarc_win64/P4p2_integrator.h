 ...
 */
#ifndef RTW_HEADER_P4p2_integrator_h_
#define RTW_HEADER_P4p2_integrator_h_
#include <string.h>
#ifndef P4p2_integrator_COMMON_INCLUDES_
# define P4p2_integrator_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* P4p2_integrator_COMMON_INCLUDES_ */

#include "P4p2_integrator_types.h"
...
#define P4p2_integrator_rtModel        RT_MODEL_P4p2_integrator_T
...
typedef struct {
  ...
  real_T Constant1[10];                /* '<S5>/Constant1' */
  ...
  real_T Integrator2_j;                /* '<Root>/Integrator2' */
...
typedef struct {
  ...
  real_T Integrator2_CSTATE_d;         /* '<Root>/Integrator2' */
...
#define rtB                            P4p2_integrator_B
#define BlockIO                        B_P4p2_integrator_T
#define rtX                            P4p2_integrator_X
#define ContinuousStates               X_P4p2_integrator_T
#define rtXdot                         P4p2_integrator_XDot
#define StateDerivatives               XDot_P4p2_integrator_T
#define tXdis                          P4p2_integrator_XDis
#define StateDisabled                  XDis_P4p2_integrator_T
#define rtP                            P4p2_integrator_P
#define Parameters                     P_P4p2_integrator_T
#define rtDWork                        P4p2_integrator_DW
#define D_Work                         DW_P4p2_integrator_T

/* Parameters (auto storage) */
struct P_P4p2_integrator_T_ {
  ...
  real_T Joystick_gain_y;              /* Variable: Joystick_gain_y
                                        ...
                                        */
  real_T K_reg[10];                    /* Variable: K_reg
...
struct tag_RTM_P4p2_integrator_T {
  const char_T *path;
...
extern P_P4p2_integrator_T P4p2_integrator_P;

/* Block signals (auto storage) */
extern B_P4p2_integrator_T P4p2_integrator_B;

/* Continuous states (auto storage) */
extern X_P4p2_integrator_T P4p2_integrator_X;

/* Block states (auto storage) */
extern DW_P4p2_integrator_T P4p2_integrator_DW;
...
extern void P4p2_integrator_initialize(void);
extern void P4p2_integrator_output0(void);
extern void P4p2_integrator_update0(void);
extern void P4p2_integrator_output(int_T tid);
extern void P4p2_integrator_update(int_T tid);
extern void P4p2_integrator_terminate(void);

/* Real-time Model object */
extern RT_MODEL_P4p2_integrator_T *const P4p2_integrator_M;
 ...
 *
 * '<Root>' : 'P4p2_integrator'
 * '<S1>'   : 'P4p2_integrator/Conversion'
 * '<S2>'   : 'P4p2_integrator/Estimator '
 * '<S3>'   : 'P4p2_integrator/Heli 3D'
 * '<S4>'   : 'P4p2_integrator/Joystick'
 * '<S5>'   : 'P4p2_integrator/lqr controller'
 * '<S6>'   : 'P4p2_integrator/Heli 3D/Elevation rad to deg'
 * '<S7>'   : 'P4p2_integrator/Heli 3D/Elevation rate rad to deg'
 * '<S8>'   : 'P4p2_integrator/Heli 3D/Pitch rad to deg'
 * '<S9>'   : 'P4p2_integrator/Heli 3D/Pitch rate rad to deg'
 * '<S10>'  : 'P4p2_integrator/Heli 3D/Travel rad to deg'
 * '<S11>'  : 'P4p2_integrator/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_P4p2_integrator_h_ */
