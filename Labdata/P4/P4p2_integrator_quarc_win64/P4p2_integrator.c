...
void P4p2_integrator_output0(void)     /* Sample time: [0.0s, 0.0s] */
{
  ...
  /* Sum: '<Root>/Sum2' */
  P4p2_integrator_B.Sum2 = P4p2_integrator_B.Integrator2[2] -
    P4p2_integrator_B.Gain7;
...
RT_MODEL_P4p2_integrator_T *P4p2_integrator(void)
{
  ...
  /* External mode info */
  P4p2_integrator_M->Sizes.checksums[0] = (826772490U);
  P4p2_integrator_M->Sizes.checksums[1] = (1729134756U);
  P4p2_integrator_M->Sizes.checksums[2] = (3253167903U);
  P4p2_integrator_M->Sizes.checksums[3] = (3860039912U);
  ...
  /* Initialize Sizes */
  P4p2_integrator_M->Sizes.numContStates = (11);/* Number of continuous states */
  ...
  P4p2_integrator_M->Sizes.numBlocks = (86);/* Number of blocks */
  P4p2_integrator_M->Sizes.numBlockIO = (41);/* Number of block outputs */
  P4p2_integrator_M->Sizes.numBlockPrms = (252);/* Sum of parameter "widths" */
