 ...
 * C source code generated on : Tue Oct 02 09:45:14 2018
 *
...
void P2p2_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
   ...
   *  Sum: '<S6>/Sum1'
   */
  P2p2_B.k_pp = (P2p2_B.Joystick_gain_x - P2p2_P.Gain1_Gain * P2p2_B.Gain) *
    P2p2_P.k_rp;
  if (rtmIsMajorTimeStep(P2p2_M)) {
  ...
  rtb_Frontgain = P2p2_X.Integrator_CSTATE;
  if (rtmIsMajorTimeStep(P2p2_M)) {
   ...
   *  Sum: '<S7>/Sum'
   */
  rtb_Backgain = ((rtb_Frontgain + P2p2_B.K_ep) - P2p2_P.Gain2_Gain *
                  P2p2_B.Gain_d * P2p2_P.K_ed_Gain) + P2p2_B.Constant1;

  /* Gain: '<S1>/Front gain' incorporates:
   *  Sum: '<S1>/Add'
   */
  rtb_Frontgain = (rtb_Sum1_f + rtb_Backgain) * P2p2_P.Frontgain_Gain;
  if (rtmIsMajorTimeStep(P2p2_M)) {
    /* Gain: '<S7>/K_ei' */
   ...
   *  Sum: '<S1>/Subtract'
   */
  rtb_DeadZoney = (rtb_Backgain - rtb_Sum1_f) * P2p2_P.Backgain_Gain;
...
RT_MODEL_P2p2_T *P2p2(void)
{
  ...
  /* External mode info */
  P2p2_M->Sizes.checksums[0] = (1916397973U);
  P2p2_M->Sizes.checksums[1] = (1743873178U);
  P2p2_M->Sizes.checksums[2] = (2155412114U);
  P2p2_M->Sizes.checksums[3] = (3063833043U);
  ...
  P2p2_M->Sizes.numBlocks = (67);      /* Number of blocks */
  P2p2_M->Sizes.numBlockIO = (26);     /* Number of block outputs */
  P2p2_M->Sizes.numBlockPrms = (162);  /* Sum of parameter "widths" */
  return P2p2_M;
}
