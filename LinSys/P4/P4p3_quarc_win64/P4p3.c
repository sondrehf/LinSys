...
void P4p3_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P4p3_M)) {
    ...
    /* S-Function Block: P4p3/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        P4p3_B.HILReadEncoderTimebase_o1 =
          P4p3_DW.HILReadEncoderTimebase_Buffer[0];
        P4p3_B.HILReadEncoderTimebase_o2 =
          P4p3_DW.HILReadEncoderTimebase_Buffer[1];
        rtb_HILReadEncoderTimebase_o3 = P4p3_DW.HILReadEncoderTimebase_Buffer[2];
      }
    }
  }
  ...
  for (i = 0; i < 6; i++) {
    P4p3_B.Integrator2[i] = P4p3_X.Integrator2_CSTATE[i];
  }
  ...
  if (rtmIsMajorTimeStep(P4p3_M)) {
    ...
    if (P4p3_B.RateTransitionx > P4p3_P.DeadZonex_End) {
      rtb_TravelTransferFcn = P4p3_B.RateTransitionx - P4p3_P.DeadZonex_End;
    } else if (P4p3_B.RateTransitionx >= P4p3_P.DeadZonex_Start) {
      rtb_TravelTransferFcn = 0.0;
    } else {
      rtb_TravelTransferFcn = P4p3_B.RateTransitionx - P4p3_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S4>/Gain: x'
     */
    P4p3_B.Joystick_gain_x = P4p3_P.Gainx_Gain * rtb_TravelTransferFcn *
      P4p3_P.Joystick_gain_x;

    /* Gain: '<Root>/Gain6' */
    P4p3_B.Gain6 = P4p3_P.Gain6_Gain * P4p3_B.Joystick_gain_x;
    ...
    if (P4p3_B.RateTransitiony > P4p3_P.DeadZoney_End) {
      rtb_TravelTransferFcn = P4p3_B.RateTransitiony - P4p3_P.DeadZoney_End;
    } else if (P4p3_B.RateTransitiony >= P4p3_P.DeadZoney_Start) {
      rtb_TravelTransferFcn = 0.0;
    } else {
      rtb_TravelTransferFcn = P4p3_B.RateTransitiony - P4p3_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S4>/Gain: y'
     */
    P4p3_B.Joystick_gain_y = P4p3_P.Gainy_Gain * rtb_TravelTransferFcn *
      P4p3_P.Joystick_gain_y;

    /* Gain: '<Root>/Gain7' */
    P4p3_B.Gain7 = P4p3_P.Gain7_Gain * P4p3_B.Joystick_gain_y;
    ...
    P4p3_B.Product[0] += P4p3_P.P[0] * P4p3_B.Gain6;
    P4p3_B.Product[0] += P4p3_P.P[2] * P4p3_B.Gain7;
    P4p3_B.Product[1] = 0.0;
    P4p3_B.Product[1] += P4p3_P.P[1] * P4p3_B.Gain6;
    P4p3_B.Product[1] += P4p3_P.P[3] * P4p3_B.Gain7;

    /* Constant: '<S5>/Constant1' */
    memcpy(&P4p3_B.Constant1[0], &P4p3_P.K_reg[0], 10U * sizeof(real_T));
  }

  /* Integrator: '<Root>/Integrator1' */
  P4p3_B.Integrator1 = P4p3_X.Integrator1_CSTATE;

  /* Integrator: '<Root>/Integrator4' */
  P4p3_B.Integrator4 = P4p3_X.Integrator4_CSTATE;

  /* SignalConversion: '<S5>/TmpSignal ConversionAtProduct2Inport2' incorporates:
   *  Product: '<S5>/Product2'
   */
  tmp[0] = P4p3_B.Integrator2[0];
  tmp[1] = P4p3_B.Integrator2[1];
  tmp[2] = P4p3_B.Integrator2[3];
  tmp[3] = P4p3_B.Integrator1;
  tmp[4] = P4p3_B.Integrator4;
  ...
  for (i = 0; i < 2; i++) {
    rtb_TravelTransferFcn = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      rtb_TravelTransferFcn += P4p3_B.Constant1[(i_0 << 1) + i] * tmp[i_0];
    }

    P4p3_B.Sum1[i] = P4p3_B.Product[i] - rtb_TravelTransferFcn;
  }
  ...
  if (rtmIsMajorTimeStep(P4p3_M)) {
     ...
     */
    P4p3_B.Sum = rtb_HILReadEncoderTimebase_o3 + P4p3_P.Constant_Value;

    /* Gain: '<S3>/Elevation: Count to rad' */
    P4p3_B.ElevationCounttorad = P4p3_P.ElevationCounttorad_Gain * P4p3_B.Sum;
  }

  /* Gain: '<S7>/Gain' incorporates:
   *  TransferFcn: '<S3>/Elevation: Transfer Fcn'
   */
  P4p3_B.Gain = (P4p3_P.ElevationTransferFcn_C *
                 P4p3_X.ElevationTransferFcn_CSTATE +
                 P4p3_P.ElevationTransferFcn_D * P4p3_B.ElevationCounttorad) *
    P4p3_P.Gain_Gain;

  /* Gain: '<Root>/Gain8' */
  P4p3_B.Gain8 = P4p3_P.Gain8_Gain * P4p3_B.Gain;
  if (rtmIsMajorTimeStep(P4p3_M)) {
  }

  /* Integrator: '<Root>/Integrator2' */
  P4p3_B.Integrator2_j = P4p3_X.Integrator2_CSTATE_d;
  if (rtmIsMajorTimeStep(P4p3_M)) {
    ...
    /* Gain: '<S8>/Gain' */
    P4p3_B.Gain_d = P4p3_P.Gain_Gain_n * P4p3_B.PitchCounttorad;

    /* Gain: '<Root>/Gain1' */
    P4p3_B.Gain1 = P4p3_P.Gain1_Gain * P4p3_B.Gain_d;
  }

  /* Gain: '<S9>/Gain' incorporates:
   *  TransferFcn: '<S3>/Pitch: Transfer Fcn'
   */
  P4p3_B.Gain_a = (P4p3_P.PitchTransferFcn_C * P4p3_X.PitchTransferFcn_CSTATE +
                   P4p3_P.PitchTransferFcn_D * P4p3_B.PitchCounttorad) *
    P4p3_P.Gain_Gain_l;

  /* Gain: '<Root>/Gain5' */
  P4p3_B.Gain5 = P4p3_P.Gain5_Gain * P4p3_B.Gain_a;
  if (rtmIsMajorTimeStep(P4p3_M)) {
  }

  /* Integrator: '<Root>/Integrator3' */
  P4p3_B.Integrator3 = P4p3_X.Integrator3_CSTATE;
  if (rtmIsMajorTimeStep(P4p3_M)) {
    /* Constant: '<Root>/Constant1' */
    P4p3_B.Constant1_d = P4p3_P.Constant1_Value;
  }

  /* Sum: '<Root>/Sum' */
  rtb_Backgain = P4p3_B.Constant1_d + P4p3_B.Sum1[0];
  if (rtmIsMajorTimeStep(P4p3_M)) {
    /* Constant: '<S2>/A' */
    memcpy(&P4p3_B.A[0], &P4p3_P.A_sys[0], 36U * sizeof(real_T));
    for (i = 0; i < 12; i++) {
      /* Constant: '<S2>/B' */
      P4p3_B.B[i] = P4p3_P.B_sys[i];

      /* Constant: '<S2>/C' */
      P4p3_B.C[i] = P4p3_P.C_sys[i];

      /* Constant: '<S2>/L' */
      P4p3_B.L[i] = P4p3_P.L[i];
    }

    /* Gain: '<S6>/Gain' */
    P4p3_B.Gain_h = P4p3_P.Gain_Gain_p * P4p3_B.ElevationCounttorad;
    ...
    /* Gain: '<S10>/Gain' */
    P4p3_B.Gain_l = P4p3_P.Gain_Gain_a * P4p3_B.TravelCounttorad;
  }

  /* Gain: '<S11>/Gain' incorporates:
   *  TransferFcn: '<S3>/Travel: Transfer Fcn'
   */
  P4p3_B.Gain_k = (P4p3_P.TravelTransferFcn_C * P4p3_X.TravelTransferFcn_CSTATE
   ...
   *  Sum: '<S2>/Sum3'
   */
  tmp_2[0] = P4p3_B.Gain_d;
  tmp_2[1] = P4p3_B.Gain_a;
  tmp_2[2] = P4p3_B.Gain_h;
  tmp_2[3] = P4p3_B.Gain;
  tmp_2[4] = P4p3_B.Gain_l;
  tmp_2[5] = P4p3_B.Gain_k;
  for (i = 0; i < 6; i++) {
    /* Product: '<S2>/Bu' incorporates:
     *  Sum: '<S2>/Sum3'
     */
    tmp_0[i] = 0.0;
    tmp_0[i] += P4p3_B.B[i] * P4p3_B.Sum1[0];
    tmp_0[i] += P4p3_B.B[i + 6] * P4p3_B.Sum1[1];
    ...
    tmp_1[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp_1[i] += P4p3_B.A[6 * i_0 + i] * P4p3_B.Integrator2[i_0];
    }

    /* End of Product: '<S2>/Ax_hat' */
    tmp_3[i] = P4p3_P.Gain9_Gain * tmp_2[i];
  }
  ...
  for (i = 0; i < 2; i++) {
    tmp_4[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp_4[i] += P4p3_B.C[(i_0 << 1) + i] * tmp_3[i_0];
    }
  }
  ...
  for (i = 0; i < 2; i++) {
    tmp_5[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp_5[i] += P4p3_B.C[(i_0 << 1) + i] * P4p3_B.Integrator2[i_0];
    }
  }
   ...
   */
  rtb_TravelTransferFcn = tmp_4[0] - tmp_5[0];
   ...
   */
  for (i = 0; i < 6; i++) {
    P4p3_B.Sum5[i] = (P4p3_B.L[i + 6] * unnamed_idx_1 + P4p3_B.L[i] *
                      rtb_TravelTransferFcn) + (tmp_0[i] + tmp_1[i]);
  }

  /* End of Sum: '<S2>/Sum5' */

  /* Gain: '<Root>/Gain2' */
  rtb_TravelTransferFcn = P4p3_P.Gain2_Gain * P4p3_B.Gain;
  if (rtmIsMajorTimeStep(P4p3_M)) {
    /* Gain: '<Root>/Gain3' */
    rtb_Gain3 = P4p3_P.Gain3_Gain * P4p3_B.Gain_d;
  }

  /* Gain: '<S1>/Front gain' incorporates:
   *  Sum: '<S1>/Add'
   */
  unnamed_idx_1 = (P4p3_B.Sum1[1] + rtb_Backgain) * P4p3_P.Frontgain_Gain;

  /* Saturate: '<S3>/Front motor: Saturation' */
  if (unnamed_idx_1 > P4p3_P.FrontmotorSaturation_UpperSat) {
    P4p3_B.FrontmotorSaturation = P4p3_P.FrontmotorSaturation_UpperSat;
  } else if (unnamed_idx_1 < P4p3_P.FrontmotorSaturation_LowerSat) {
    P4p3_B.FrontmotorSaturation = P4p3_P.FrontmotorSaturation_LowerSat;
  } else {
    P4p3_B.FrontmotorSaturation = unnamed_idx_1;
  }
   ...
   *  Sum: '<S1>/Subtract'
   */
  unnamed_idx_1 = (rtb_Backgain - P4p3_B.Sum1[1]) * P4p3_P.Backgain_Gain;

  /* Saturate: '<S3>/Back motor: Saturation' */
  if (unnamed_idx_1 > P4p3_P.BackmotorSaturation_UpperSat) {
    P4p3_B.BackmotorSaturation = P4p3_P.BackmotorSaturation_UpperSat;
  } else if (unnamed_idx_1 < P4p3_P.BackmotorSaturation_LowerSat) {
    P4p3_B.BackmotorSaturation = P4p3_P.BackmotorSaturation_LowerSat;
  } else {
    P4p3_B.BackmotorSaturation = unnamed_idx_1;
  }
  ...
  /* Sum: '<Root>/Sum1' */
  P4p3_B.Sum1_n = P4p3_B.Integrator2[0] - P4p3_B.Gain6;

  /* Sum: '<Root>/Sum2' */
  P4p3_B.Sum2 = P4p3_B.Integrator2[3] - P4p3_B.Gain7;
  if (rtmIsMajorTimeStep(P4p3_M)) {
    /* Sum: '<Root>/Sum3' */
    P4p3_B.Sum3 = rtb_Gain3 - P4p3_B.Gain6;
  }

  /* Sum: '<Root>/Sum4' */
  P4p3_B.Sum4 = rtb_TravelTransferFcn - P4p3_B.Gain7;
  if (rtmIsMajorTimeStep(P4p3_M)) {
  }
}
...
void P4p3_derivatives(void)
{
  ...
  for (i = 0; i < 6; i++) {
    _rtXdot->Integrator2_CSTATE[i] = P4p3_B.Sum5[i];
  }

  /* End of Derivatives for Integrator: '<S2>/Integrator2' */

  /* Derivatives for Integrator: '<Root>/Integrator1' */
  _rtXdot->Integrator1_CSTATE = P4p3_B.Sum1_n;

  /* Derivatives for Integrator: '<Root>/Integrator4' */
  _rtXdot->Integrator4_CSTATE = P4p3_B.Sum2;
  ...
  _rtXdot->Integrator2_CSTATE_d = P4p3_B.Sum3;
  ...
  _rtXdot->Integrator3_CSTATE = P4p3_B.Sum4;
...
void P4p3_initialize(void)
{
  ...
  /* S-Function Block: P4p3/HIL Initialize (hil_initialize_block) */
  {
    ...
    if ((P4p3_P.HILInitialize_set_analog_input_ && !is_switching) ||
        (P4p3_P.HILInitialize_set_analog_inpu_f && is_switching)) {
      {
        int_T i1;
    ...
    if ((P4p3_P.HILInitialize_set_analog_output && !is_switching) ||
        (P4p3_P.HILInitialize_set_analog_outp_g && is_switching)) {
      {
        int_T i1;
    ...
    if ((P4p3_P.HILInitialize_set_analog_outp_h && !is_switching) ||
    ...
    if (P4p3_P.HILInitialize_set_analog_outp_l) {
      {
        int_T i1;
        real_T *dw_AOVoltages = &P4p3_DW.HILInitialize_AOVoltages[0];
        for (i1=0; i1 < 8; i1++) {
    ...
    if ((P4p3_P.HILInitialize_set_encoder_param && !is_switching) ||
        (P4p3_P.HILInitialize_set_encoder_par_e && is_switching)) {
      {
        int_T i1;
    ...
    if ((P4p3_P.HILInitialize_set_encoder_count && !is_switching) ||
        (P4p3_P.HILInitialize_set_encoder_cou_d && is_switching)) {
      {
        int_T i1;
    ...
    if ((P4p3_P.HILInitialize_set_pwm_params_at && !is_switching) ||
        (P4p3_P.HILInitialize_set_pwm_params__n && is_switching)) {
    ...
    if ((P4p3_P.HILInitialize_set_pwm_outputs_a && !is_switching) ||
        (P4p3_P.HILInitialize_set_pwm_outputs_b && is_switching)) {
      {
        int_T i1;
        real_T *dw_POValues = &P4p3_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
...

  {
    ...
    for (i = 0; i < 6; i++) {
      P4p3_X.Integrator2_CSTATE[i] = P4p3_P.Integrator2_IC;
    }
    ...
    P4p3_X.Integrator2_CSTATE_d = P4p3_P.Integrator2_IC_i;
...
void P4p3_terminate(void)
{
  ...
  /* S-Function Block: P4p3/HIL Initialize (hil_initialize_block) */
  {
    ...
    is_switching = false;
    if ((P4p3_P.HILInitialize_set_analog_outp_m && !is_switching) ||
        (P4p3_P.HILInitialize_set_analog_out_j0 && is_switching)) {
      {
        int_T i1;
        real_T *dw_AOVoltages = &P4p3_DW.HILInitialize_AOVoltages[0];
        for (i1=0; i1 < 8; i1++) {
    ...
    if ((P4p3_P.HILInitialize_set_pwm_outputs_c && !is_switching) ||
        (P4p3_P.HILInitialize_set_pwm_outputs_l && is_switching)) {
      {
        int_T i1;
        real_T *dw_POValues = &P4p3_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
...
RT_MODEL_P4p3_T *P4p3(void)
{
  ...
  /* External mode info */
  P4p3_M->Sizes.checksums[0] = (803380120U);
  P4p3_M->Sizes.checksums[1] = (1423136885U);
  P4p3_M->Sizes.checksums[2] = (1777486864U);
  P4p3_M->Sizes.checksums[3] = (2778152226U);
...

  {
    ...
    P4p3_B.HILReadEncoderTimebase_o1 = 0.0;
    P4p3_B.HILReadEncoderTimebase_o2 = 0.0;
    ...
    P4p3_B.Product[0] = 0.0;
    P4p3_B.Product[1] = 0.0;
    P4p3_B.Integrator1 = 0.0;
    P4p3_B.Integrator4 = 0.0;
    P4p3_B.Sum1[0] = 0.0;
    P4p3_B.Sum1[1] = 0.0;
    P4p3_B.Sum = 0.0;
    ...
    P4p3_B.Gain = 0.0;
    P4p3_B.Gain8 = 0.0;
    P4p3_B.Integrator2_j = 0.0;
    P4p3_B.PitchCounttorad = 0.0;
    P4p3_B.Gain_d = 0.0;
    P4p3_B.Gain1 = 0.0;
    P4p3_B.Gain_a = 0.0;
    P4p3_B.Gain5 = 0.0;
    P4p3_B.Integrator3 = 0.0;
    P4p3_B.Constant1_d = 0.0;
    P4p3_B.Gain_h = 0.0;
  ...
  /* Initialize Sizes */
  P4p3_M->Sizes.numContStates = (13);  /* Number of continuous states */
  ...
  P4p3_M->Sizes.numBlocks = (92);      /* Number of blocks */
  P4p3_M->Sizes.numBlockIO = (43);     /* Number of block outputs */
  P4p3_M->Sizes.numBlockPrms = (242);  /* Sum of parameter "widths" */
  return P4p3_M;
}
