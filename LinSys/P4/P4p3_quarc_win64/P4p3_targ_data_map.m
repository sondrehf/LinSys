  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% P4p3_P.HILInitialize_set_other_outpu_g
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 100;
	
	  ;% P4p3_P.HILInitialize_set_other_outpu_f
	  ...
	  ;% P4p3_P.HILInitialize_set_analog_inpu_f
	  ...
	  ;% P4p3_P.HILInitialize_set_analog_outp_g
	  ...
	  ;% P4p3_P.HILInitialize_set_analog_out_j0
	  section.data(10).logicalSrcIdx = 50;
	  section.data(10).dtTransOffset = 9;
	
	  ;% P4p3_P.HILInitialize_set_analog_outp_m
	  ...
	  ;% P4p3_P.HILInitialize_set_clock_frequ_b
	  ...
	  ;% P4p3_P.HILInitialize_set_clock_param_o
	  ...
	  ;% P4p3_P.HILInitialize_set_digital_out_k
	  ...
	  ;% P4p3_P.HILInitialize_set_digital_out_o
	  ...
	  ;% P4p3_P.HILInitialize_set_digital_ou_oj
	  ...
	  ;% P4p3_P.HILInitialize_set_encoder_cou_d
	  ...
	  ;% P4p3_P.HILInitialize_set_encoder_par_e
	  ...
	  ;% P4p3_P.HILInitialize_set_pwm_outputs_b
	  section.data(30).logicalSrcIdx = 70;
	  section.data(30).dtTransOffset = 29;
	
	  ;% P4p3_P.HILInitialize_set_pwm_outputs_l
	  ...
	  ;% P4p3_P.HILInitialize_set_pwm_params__n
  ...
  ;%**************************
    ...
    ;%
	  ...
	  section.data(36).dtTransOffset = 124;
	
	  ;% P4p3_B.BackmotorSaturation
	  section.data(37).logicalSrcIdx = 36;
	  section.data(37).dtTransOffset = 125;
	  ...
	  section.data(39).dtTransOffset = 127;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P4p3_DW.Voltage_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 18;
	  section.data(5).dtTransOffset = 4;
	
	  ;% P4p3_DW.elrate_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 19;
	  section.data(6).dtTransOffset = 5;
	
	  ;% P4p3_DW.gamma_PWORK.LoggedData
	  ...
	  ;% P4p3_DW.zheta_PWORK.LoggedData
  ...
  targMap.checksum0 = 803380120;
  targMap.checksum1 = 1423136885;
  targMap.checksum2 = 1777486864;
  targMap.checksum3 = 2778152226;
