...
MODEL                = P4p2_integrator
MODULES              = P4p2_integrator_data.c P4p2_integrator_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = P4p2_integrator.mk
...
MODELLIB                  = P4p2_integratorlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = P4p2_integrator_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\hermankj\Desktop\Herman\P4
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\P4p2_integrator_quarc_win64
