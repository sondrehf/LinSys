 ...
 * C source code generated on : Thu Oct 18 17:42:03 2018
 *
...
void P2p1_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
    ...
    /* S-Function Block: P2p1/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        P2p1_B.HILReadEncoderTimebase_o1 =
          P2p1_DW.HILReadEncoderTimebase_Buffer[0];
        P2p1_B.HILReadEncoderTimebase_o2 =
          P2p1_DW.HILReadEncoderTimebase_Buffer[1];
        rtb_Sum_k = P2p1_DW.HILReadEncoderTimebase_Buffer[2];
      }
    }
    ...
    /* Gain: '<Root>/Gain3' */
    P2p1_B.Gain3 = P2p1_P.Gain3_Gain * P2p1_B.Gain;
  }
  ...
  rtb_Frontgain = P2p1_X.Integrator_CSTATE;
  if (rtmIsMajorTimeStep(P2p1_M)) {
    /* Sum: '<S3>/Sum' incorporates:
     *  Constant: '<S3>/Constant'
     */
    P2p1_B.Sum = rtb_Sum_k + P2p1_P.Constant_Value;

    /* Gain: '<S3>/Elevation: Count to rad' */
    P2p1_B.ElevationCounttorad = P2p1_P.ElevationCounttorad_Gain * P2p1_B.Sum;
     ...
     *  Gain: '<Root>/Gain5'
     */
    rtb_Sum_k = P2p1_P.Constant_Value_o - P2p1_P.Gain5_Gain * P2p1_B.Gain_e;

    /* Gain: '<S7>/K_ep' */
    P2p1_B.K_ep = P2p1_P.K_ep_Gain * rtb_Sum_k;
  }
   ...
   *  Gain: '<S7>/K_ed'
   */
  P2p1_B.Sum_l = (rtb_Frontgain + P2p1_B.K_ep) - P2p1_P.Gain2_Gain *
    P2p1_B.Gain_d * P2p1_P.K_ed_Gain;
  if (rtmIsMajorTimeStep(P2p1_M)) {
    /* Constant: '<Root>/Constant1' */
    P2p1_B.Constant1 = P2p1_P.Constant1_Value;
    ...
    if (P2p1_B.RateTransitionx > P2p1_P.DeadZonex_End) {
      rtb_Step1 = P2p1_B.RateTransitionx - P2p1_P.DeadZonex_End;
    } else if (P2p1_B.RateTransitionx >= P2p1_P.DeadZonex_Start) {
      rtb_Step1 = 0.0;
    } else {
      rtb_Step1 = P2p1_B.RateTransitionx - P2p1_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S5>/Gain: x'
     */
    P2p1_B.Joystick_gain_x = P2p1_P.Gainx_Gain * rtb_Step1 *
      P2p1_P.Joystick_gain_x;

    /* Gain: '<S6>/k_pp ' incorporates:
     *  Sum: '<S6>/Sum'
     */
    P2p1_B.k_pp = (P2p1_B.Joystick_gain_x - P2p1_B.Gain3) * P2p1_P.k_pp;
  }
   ...
   *  Gain: '<S6>/k_pd '
   */
  rtb_Step1 = P2p1_B.k_pp - P2p1_P.Gain4_Gain * P2p1_B.Gain_b * P2p1_P.k_pd;

  /* Sum: '<Root>/Sum' */
  rtb_Frontgain = P2p1_B.Constant1 + P2p1_B.Sum_l;

  /* Sum: '<S1>/Subtract' */
  rtb_Subtract = rtb_Frontgain - rtb_Step1;

  /* Gain: '<S1>/Front gain' incorporates:
   *  Sum: '<S1>/Add'
   */
  rtb_Frontgain = (rtb_Step1 + rtb_Frontgain) * P2p1_P.Frontgain_Gain;
  if (rtmIsMajorTimeStep(P2p1_M)) {
    /* Gain: '<S7>/K_ei' */
    P2p1_B.K_ei = P2p1_P.K_ei_Gain * rtb_Sum_k;
   ...
   */
  P2p1_B.Gain_dc = (P2p1_P.TravelTransferFcn_C * P2p1_X.TravelTransferFcn_CSTATE
  ...
  /* Gain: '<S1>/Back gain' */
  rtb_Step1 = P2p1_P.Backgain_Gain * rtb_Subtract;

  /* Saturate: '<S3>/Back motor: Saturation' */
  if (rtb_Step1 > P2p1_P.BackmotorSaturation_UpperSat) {
    P2p1_B.BackmotorSaturation = P2p1_P.BackmotorSaturation_UpperSat;
  } else if (rtb_Step1 < P2p1_P.BackmotorSaturation_LowerSat) {
    P2p1_B.BackmotorSaturation = P2p1_P.BackmotorSaturation_LowerSat;
  } else {
    P2p1_B.BackmotorSaturation = rtb_Step1;
  }
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
    ...
    if (P2p1_B.RateTransitiony > P2p1_P.DeadZoney_End) {
      rtb_Step1 = P2p1_B.RateTransitiony - P2p1_P.DeadZoney_End;
    } else if (P2p1_B.RateTransitiony >= P2p1_P.DeadZoney_Start) {
      rtb_Step1 = 0.0;
    } else {
      rtb_Step1 = P2p1_B.RateTransitiony - P2p1_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S5>/Gain: y'
     */
    P2p1_B.Joystick_gain_y = P2p1_P.Gainy_Gain * rtb_Step1 *
      P2p1_P.Joystick_gain_y;
  }

  /* Step: '<S4>/Step' */
  if (P2p1_M->Timing.t[0] < P2p1_P.Step_Time) {
    rtb_Step1 = P2p1_P.Step_Y0;
  } else {
    rtb_Step1 = P2p1_P.Step_YFinal;
  }

  /* End of Step: '<S4>/Step' */

  /* Step: '<S4>/Step1' */
  if (P2p1_M->Timing.t[0] < P2p1_P.Step1_Time) {
    rtb_Subtract = P2p1_P.Step1_Y0;
  } else {
    rtb_Subtract = P2p1_P.Step1_YFinal;
  }

  /* End of Step: '<S4>/Step1' */

  /* Sum: '<S4>/Sum1' */
  P2p1_B.Sum1 = rtb_Step1 - rtb_Subtract;
  if (rtmIsMajorTimeStep(P2p1_M)) {
  }
}
...
RT_MODEL_P2p1_T *P2p1(void)
{
  ...
  /* External mode info */
  P2p1_M->Sizes.checksums[0] = (3646836180U);
  P2p1_M->Sizes.checksums[1] = (3550340967U);
  P2p1_M->Sizes.checksums[2] = (949665710U);
  P2p1_M->Sizes.checksums[3] = (400516615U);
  ...
  {
    P2p1_B.HILReadEncoderTimebase_o1 = 0.0;
    P2p1_B.HILReadEncoderTimebase_o2 = 0.0;
  ...
  P2p1_M->Sizes.numBlocks = (66);      /* Number of blocks */
  P2p1_M->Sizes.numBlockIO = (27);     /* Number of block outputs */
  P2p1_M->Sizes.numBlockPrms = (162);  /* Sum of parameter "widths" */
  return P2p1_M;
}
