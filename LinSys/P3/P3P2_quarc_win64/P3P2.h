...
typedef struct {
  ...
  real_T Product[2];                   /* '<S6>/Product' */
  real_T Constant1_d[6];               /* '<S6>/Constant1' */
  real_T Gain_a;                       /* '<S10>/Gain' */
 ...
 * '<S4>'   : 'P3P2/Impulse1'
 * '<S5>'   : 'P3P2/Joystick'
 * '<S6>'   : 'P3P2/lqr controller'
 * '<S7>'   : 'P3P2/Heli 3D/Elevation rad to deg'
 * '<S8>'   : 'P3P2/Heli 3D/Elevation rate rad to deg'
 * '<S9>'   : 'P3P2/Heli 3D/Pitch rad to deg'
 * '<S10>'  : 'P3P2/Heli 3D/Pitch rate rad to deg'
 * '<S11>'  : 'P3P2/Heli 3D/Travel rad to deg'
 * '<S12>'  : 'P3P2/Heli 3D/Travel rate  rad to deg'
 */
