...
typedef struct {
  ...
  real_T Constant1[10];                /* '<S6>/Constant1' */
  ...
  real_T Sum1_j;                       /* '<Root>/Sum1' */
  real_T Sum2;                         /* '<Root>/Sum2' */
  real_T Sum1_n;                       /* '<S3>/Sum1' */
  real_T Sum1_i;                       /* '<S4>/Sum1' */
} B_P3P3_T;
...
struct P_P3P3_T_ {
  ...
  real_T Step1_YFinal;                 /* Expression: 0.5
                                        * Referenced by: '<S3>/Step1'
                                        */
  real_T Step_Time_k;                  /* Expression: 7
                                        * Referenced by: '<S4>/Step'
                                        */
  real_T Step_Y0_n;                    /* Expression: 0
                                        * Referenced by: '<S4>/Step'
                                        */
  real_T Step_YFinal_j;                /* Expression: 0.2
                                        * Referenced by: '<S4>/Step'
                                        */
  real_T Step1_Time_l;                 /* Expression: 12
                                        * Referenced by: '<S4>/Step1'
                                        */
  real_T Step1_Y0_j;                   /* Expression: 0
                                        * Referenced by: '<S4>/Step1'
                                        */
  real_T Step1_YFinal_d;               /* Expression: 0.2
                                        * Referenced by: '<S4>/Step1'
                                        */
