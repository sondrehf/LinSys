...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&P3P3_B.HILReadEncoderTimebase_o1), 0, 0, 43 }
  ,
  ...
  { (char_T *)(&P3P3_DW.ToWorkspace1_PWORK.LoggedData), 11, 0, 18 },
...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&P3P3_P.Joystick_gain_x), 0, 0, 33 },
  ...
  { (char_T *)(&P3P3_P.PitchCounttorad_Gain), 0, 0, 54 },
