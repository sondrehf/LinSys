...
void P3P3_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P3P3_M)) {
    ...
    /* Gain: '<Root>/Gain2' */
    P3P3_B.Gain2 = P3P3_P.Gain2_Gain * P3P3_B.Gain;
    ...
    /* Gain: '<S7>/Gain' */
    P3P3_B.Gain_h = P3P3_P.Gain_Gain_p * P3P3_B.ElevationCounttorad;

    /* Gain: '<Root>/Gain4' */
    P3P3_B.Gain4 = P3P3_P.Gain4_Gain * P3P3_B.Gain_h;
  }
  ...
  /* Gain: '<Root>/Gain1' */
  P3P3_B.Gain1 = P3P3_P.Gain1_Gain * P3P3_B.Gain_g;
  if (rtmIsMajorTimeStep(P3P3_M)) {
    ...
    if (P3P3_B.RateTransitiony > P3P3_P.DeadZoney_End) {
      rtb_Step = P3P3_B.RateTransitiony - P3P3_P.DeadZoney_End;
    } else if (P3P3_B.RateTransitiony >= P3P3_P.DeadZoney_Start) {
      rtb_Step = 0.0;
    } else {
      rtb_Step = P3P3_B.RateTransitiony - P3P3_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S5>/Gain: y'
     */
    P3P3_B.Joystick_gain_y = P3P3_P.Gainy_Gain * rtb_Step *
   ...
   */
  tmp[0] = P3P3_B.Gain2;
  tmp[1] = P3P3_P.Gain3_Gain * P3P3_B.Gain_a;
  tmp[2] = P3P3_B.Gain1;
  ...
  for (i = 0; i < 2; i++) {
    rtb_Step = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      rtb_Step += P3P3_B.Constant1[(i_0 << 1) + i] * tmp[i_0];
    }

    P3P3_B.Sum1[i] = P3P3_B.Product[i] - rtb_Step;
  }
  ...
  /* Sum: '<Root>/Sum' */
  rtb_Step = P3P3_B.Constant1_d + P3P3_B.Sum1[0];
  if (rtmIsMajorTimeStep(P3P3_M)) {
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (P3P3_B.Sum1[1] + rtb_Step) * P3P3_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_Step - P3P3_B.Sum1[1]) * P3P3_P.Backgain_Gain;
  ...
  if (rtmIsMajorTimeStep(P3P3_M)) {
    ...
    /* Sum: '<Root>/Sum1' */
    P3P3_B.Sum1_j = P3P3_B.Gain2 - rtb_Gain6;
  }

  /* Sum: '<Root>/Sum2' */
  P3P3_B.Sum2 = P3P3_B.Gain1 - P3P3_B.Gain7;

  /* Step: '<S3>/Step' */
  if (P3P3_M->Timing.t[0] < P3P3_P.Step_Time) {
    rtb_Step = P3P3_P.Step_Y0;
  } else {
    rtb_Step = P3P3_P.Step_YFinal;
  }

  /* End of Step: '<S3>/Step' */

  /* Step: '<S3>/Step1' */
  if (P3P3_M->Timing.t[0] < P3P3_P.Step1_Time) {
    u0 = P3P3_P.Step1_Y0;
  } else {
    u0 = P3P3_P.Step1_YFinal;
  }

  /* End of Step: '<S3>/Step1' */

  /* Sum: '<S3>/Sum1' */
  P3P3_B.Sum1_n = rtb_Step - u0;
  if (rtmIsMajorTimeStep(P3P3_M)) {
  }

  /* Step: '<S4>/Step' */
  if (P3P3_M->Timing.t[0] < P3P3_P.Step_Time_k) {
    rtb_Step = P3P3_P.Step_Y0_n;
  } else {
    rtb_Step = P3P3_P.Step_YFinal_j;
  }

  /* End of Step: '<S4>/Step' */

  /* Step: '<S4>/Step1' */
  if (P3P3_M->Timing.t[0] < P3P3_P.Step1_Time_l) {
    u0 = P3P3_P.Step1_Y0_j;
  } else {
    u0 = P3P3_P.Step1_YFinal_d;
  }

  /* End of Step: '<S4>/Step1' */

  /* Sum: '<S4>/Sum1' */
  P3P3_B.Sum1_i = rtb_Step - u0;
  if (rtmIsMajorTimeStep(P3P3_M)) {
  }
}
...
void P3P3_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE = P3P3_B.Sum1_j;
...
RT_MODEL_P3P3_T *P3P3(void)
{
  ...
  /* External mode info */
  P3P3_M->Sizes.checksums[0] = (1417278393U);
  P3P3_M->Sizes.checksums[1] = (1188719217U);
  P3P3_M->Sizes.checksums[2] = (1207869645U);
  P3P3_M->Sizes.checksums[3] = (703919085U);
  ...
  P3P3_M->Sizes.numBlocks = (74);      /* Number of blocks */
  P3P3_M->Sizes.numBlockIO = (32);     /* Number of block outputs */
  P3P3_M->Sizes.numBlockPrms = (177);  /* Sum of parameter "widths" */
  return P3P3_M;
}
